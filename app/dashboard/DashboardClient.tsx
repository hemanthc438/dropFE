            ...
            <main className="relative overflow-hidden bg-black text-white min-h-screen">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        {[
                            { label: "Total Projects", value: stats.totalProjects.toString(), icon: "📁", color: "from-purple-500 to-pink-500" },
                            { label: "Emails Sent", value: stats.totalApiCalls.toString(), icon: "⚡", color: "from-cyan-500 to-blue-500" },
                            { label: "Success Rate", value: `${stats.successRate}%`, icon: "✓", color: "from-emerald-500 to-green-500" }
                        ].map((stat, i) => (
                            <div
                                key={i}
